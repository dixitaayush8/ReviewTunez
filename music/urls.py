...
from .views import search, song_page, album_page, artist_page, list_reviews, recommendations, new_releases, search_video, search_lyrics
...
urlpatterns = [
	...
	url(r'^searchlyrics/', search_lyrics)
]